...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_UserCalculator_vue__ = __webpack_require__(244);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_UserCalculator_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_UserCalculator_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_vee_validate__ = __webpack_require__(32);
...
jQuery(document).ready(function () {
    var calculators = jQuery('.ninja_mortgage_calculator_instance');
    calculators.each(function (index, calc) {
        var instanceId = jQuery(calc).data('instance_id');
        var elementId = '#ninja_mortgage_calculator_instance_' + instanceId;
        new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
            ...
            render: function render(h) {
                return h(__WEBPACK_IMPORTED_MODULE_1__components_UserCalculator_vue___default.a);
            }
        });
    });
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    components: {
        'app-mortgage-calc': __WEBPACK_IMPORTED_MODULE_0__core_MortgageCalculator_vue___default.a,
        'app-mortgage-refinance': __WEBPACK_IMPORTED_MODULE_1__core_MortgageRefinance_vue___default.a,
        'app-mortgage-payment': __WEBPACK_IMPORTED_MODULE_2__core_MortgagePayment_vue___default.a
    },
    created: function created() {
        var vars = window['ninja_mortgage_cal_vars_' + this.instance_id];
        var res = vars.mortgageMetaData;
        var post = vars.post;
...
Component.options.__file = "src/js/components/core/_MortgageCalculator.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6675cd39", Component.options)
  } else {
    hotAPI.reload("data-v-6675cd39", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        paymentSchedule: function paymentSchedule() {
            var _this = this;
            ...
            while (i <= this.monthlyPayment) {
                ...
                this.gridData.forEach(function (element) {
                    ...
                    if (_this.months[monthIndex] == 'Jan' || monthIndex == 12) {
                        ...
                        element.PaymentDate = _this.months[monthIndex] + ' ' + (root_year + 1).toString();

                        root_year = root_year + 1;
                    } else {
                        element.PaymentDate = _this.months[monthIndex] + ' ' + root_year.toString();
                    }

                    element.payment = _this.monthlyPayment.toFixed(3);
                    ...
                    if (p - principal_upd < 1) {
                        ...
                        _this.estPayOffDate = element.PaymentDate;
                    } else {
        ...
        getLoanAmount: function getLoanAmount(str) {
            if (str == '') {
                str = 'Loan Amount';
            }
            return str;
        },
        getDownPayment: function getDownPayment(str) {
            if (str == '') {
                str = 'Down Payment';
            }
            return str;
        },
        getPercentage: function getPercentage(x) {
            if (x == '') {
                x = 'Down Payment';
            }
            return x + ' Percentage';
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "mortgage_calculator ninja_mortgage_calc_wrapper" },
    [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              ...
              attrs: {
                ...
                placeholder: _vm.getLoanAmount(_vm.mortgageCalcLabel.loanAmount)
              },
            ...
            _c("div", { staticClass: "inp_fields" }, [
              _c("input", {
                ...
                attrs: {
                  ...
                  id: "downPament",
                  name: "downPament",
                  placeholder: _vm.getDownPayment(
                    _vm.mortgageCalcLabel.downPament
                  )
                },
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              ...
              attrs: {
                ...
                placeholder: _vm.getAnnualIntRate(
                  _vm.mortgageCalcLabel.annualInterestRate
                ),
                pattern: "/^-?\\d+\\.?\\d*$/",
                onKeyPress: "if(this.value.length==2) return false;"
      ...
      _vm.showTable
        ? _c("div", { staticClass: "ammortization_section" }, [
            ...
            _c(
              "div",
              { staticStyle: { "overflow-x": "auto", width: "100%" } },
              [
                _c("table", [
                  _vm._m(2),
                  _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6675cd39", module.exports)
  }
}
...
Component.options.__file = "src/js/components/core/_MortgageRefinance.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0b88ce40", Component.options)
  } else {
    hotAPI.reload("data-v-0b88ce40", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['tableTitle', 'mortgageRefinanceLabel', 'mortgageRefinanceDef', 'currencyType'],
    data: function data() {
        return {
    ...
    created: function created() {
        ...
        var balancePoints = parseFloat(this.balance / 100);
    ...
    watch: {
        current_monthly_payment: function current_monthly_payment() {
        ...
        new_interest_rate: function new_interest_rate() {
        ...
        new_loan_term: function new_loan_term() {
            this.new_loan_term_upd = parseFloat(this.new_loan_term) * 12;
            if (this.new_interest_rate != 0) {
                this.new_interest_rate_upd = parseFloat(this.new_interest_rate / 12 / 100);
            }
    ...
    computed: {
        ...
        diff_in_interest: function diff_in_interest() {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "mortgage_finance_calc ninja_mortgage_calc_wrapper" },
    [
      _c("h3", [_vm._v(_vm._s(_vm.tableTitle))]),
      _vm._v(" "),
      _c("div", { staticClass: "currentlyMonthlyPaymentSection" }, [
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.current_monthly_payment,
              ...
              staticClass: "typeNumbers",
              class: { error: _vm.errors.has("current_monthly_payment") },
              attrs: {
                type: "number",
                min: "0",
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.current_monthly_payment = $event.target.value
                }
              }
            })
          ]),
          _vm._v(" "),
          _vm.errors.has("current_monthly_payment")
            ? _c("span", { staticStyle: { color: "red" } }, [
                _vm._v(
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.current_loan_interest_rate,
                  expression: "current_loan_interest_rate"
                },
                {
                  name: "validate",
                  rawName: "v-validate",
              ...
              staticClass: "typeNumbers",
              class: { error: _vm.errors.has("current_loan_interest_rate") },
              attrs: {
                type: "number",
                min: "0",
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.current_loan_interest_rate = $event.target.value
                }
              }
            })
          ]),
          _vm._v(" "),
          _vm.errors.has("current_loan_interest_rate")
            ? _c("span", { staticStyle: { color: "red" } }, [
                _vm._v(
                  "\n                Current loan interest rate field is required\n            "
                )
      ...
      _vm._v(" "),
      _c("div", { staticClass: "balanceleftonMortgageSection" }, [
        _c("div", { staticClass: "common" }, [
          _c("label", [
            _vm._v(
              _vm._s(
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              ...
              staticClass: "typeNumbers",
              class: { error: _vm.errors.has("balance") },
              attrs: {
                type: "number",
                min: "0",
                id: "balance",
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.new_interest_rate,
                  expression: "new_interest_rate"
                },
                {
                  name: "validate",
                  rawName: "v-validate",
              ...
              staticClass: "typeNumbers",
              class: { error: _vm.errors.has("new_interest_rate") },
              attrs: {
                type: "number",
                min: "0",
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.new_interest_rate = $event.target.value
                }
              }
            })
          ]),
          _vm._v(" "),
          _vm.errors.has("new_interest_rate")
            ? _c("span", { staticStyle: { color: "red" } }, [
                _vm._v(
      ...
      _vm._v(" "),
      _c("div", { staticClass: "remainingLoanTermSection" }, [
        _c("div", { staticClass: "common" }, [
          _c("label", [
            _vm._v(
              _vm._s(
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.remaining_loan_term,
                  expression: "remaining_loan_term"
                },
                {
                  name: "validate",
                  rawName: "v-validate",
              ...
              staticClass: "typeNumbers",
              class: { error: _vm.errors.has("remaining_loan_term") },
              attrs: {
                type: "number",
                min: "0",
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.remaining_loan_term = $event.target.value
                }
              }
            })
          ]),
          _vm._v(" "),
          _vm.errors.has("remaining_loan_term")
            ? _c("span", { staticStyle: { color: "red" } }, [
                _vm._v(
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.new_loan_term,
                  expression: "new_loan_term"
                },
                {
                  name: "validate",
                  rawName: "v-validate",
              ...
              staticClass: "typeNumbers",
              class: { error: _vm.errors.has("new_loan_term") },
              attrs: {
                type: "number",
                min: "0",
                id: "new_loan_term",
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.new_loan_term = $event.target.value
                }
              }
            })
          ]),
          _vm._v(" "),
          _vm.errors.has("new_loan_term")
            ? _c("span", { staticStyle: { color: "red" } }, [
                _vm._v(
      ...
      _c("div", { staticClass: "fees_section_points" }, [
        _c("div", { staticClass: "points" }, [
          _c("label", [
            _vm._v(
              _vm._s(
                !_vm.mortgageRefinanceLabel.points
                  ? "Points"
                  : _vm.mortgageRefinanceLabel.points
              )
            )
            ...
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.application_fee,
                  expression: "application_fee"
                }
              ],
              staticClass: "typeNumbers",
              attrs: {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.application_fee = $event.target.value
                }
              }
            })
          ])
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.credit_check,
                  expression: "credit_check"
                }
              ],
              staticClass: "typeNumbers",
              attrs: {
              ...
              domProps: { value: _vm.credit_check },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.credit_check = $event.target.value
                }
              }
            })
          ])
            ...
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.attorney_fee_yours,
                  expression: "attorney_fee_yours"
                }
              ],
              staticClass: "typeNumbers",
              attrs: {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.attorney_fee_yours = $event.target.value
                }
              }
            })
          ])
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.attorney_fee_lenders,
                  expression: "attorney_fee_lenders"
                }
              ],
              staticClass: "typeNumbers",
              attrs: {
              ...
              domProps: { value: _vm.attorney_fee_lenders },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.attorney_fee_lenders = $event.target.value
                }
              }
            })
          ])
            ...
            _c("input", {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.title_search = $event.target.value
                }
              }
            })
          ])
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.title_insurance,
                  expression: "title_insurance"
                }
              ],
              staticClass: "typeNumbers",
              attrs: {
              ...
              domProps: { value: _vm.title_insurance },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.title_insurance = $event.target.value
                }
              }
            })
          ])
            ...
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.appraisal_fee,
                  expression: "appraisal_fee"
                }
              ],
              staticClass: "typeNumbers",
              attrs: {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.appraisal_fee = $event.target.value
                }
              }
            })
          ])
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              ...
              domProps: { value: _vm.inspections },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.inspections = $event.target.value
                }
              }
            })
          ])
            ...
            _c("input", {
              ...
              on: {
                input: function($event) {
                  ...
                  _vm.local_fees = $event.target.value
                }
              }
            })
          ])
        ...
        _c("div", { staticClass: "common" }, [
          ...
          _c("div", { staticClass: "inp_fields" }, [
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.document_preparation,
                  expression: "document_preparation"
                }
              ],
              staticClass: "typeNumbers",
              attrs: {
              ...
              domProps: { value: _vm.document_preparation },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.document_preparation = $event.target.value
                }
              }
            })
          ])
      ...
      _c("div", { staticClass: "costs_section" }, [
        ...
        _vm._v(" "),
        _c("h1", [
          _c("span", [_vm._v(_vm._s(_vm.currencyType))]),
          _vm._v(" " + _vm._s(_vm.monthly_payment.toFixed(2)))
        ]),
        _vm._v(" "),
        _c("p", [
          ...
          _vm._v(
            ": " +
              _vm._s(_vm.currencyType) +
              " " +
              _vm._s(_vm.monthly_savings.toFixed(2))
          )
        ]),
        _vm._v(" "),
        _c("p", [
          ...
          _vm._v(
            ": " +
              _vm._s(_vm.currencyType) +
              " " +
              _vm._s(_vm.diff_in_interest.toFixed(2))
          )
        ]),
        _vm._v(" "),
        _c("p", [
        ...
        _c("p", [
          ...
          _vm._v(
            ": " +
              _vm._s(_vm.currencyType) +
              " " +
              _vm._s(_vm.months_rec_costs.toFixed(2))
          )
        ])
      ])
    ]
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", [_c("b", [_vm._v("New Monthly Payment")])])
  }
]
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0b88ce40", module.exports)
  }
}
...
Component.options.__file = "src/js/components/core/_MortgagePayment.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-41374d5f", Component.options)
  } else {
    hotAPI.reload("data-v-41374d5f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    props: ['tableTitle', 'mortgagePaymentLabel', 'mortgagePaymentDefault', 'currencyType'],
    data: function data() {
        return {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "mortgage_payment_calc ninja_mortgage_calc_wrapper" },
    [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-41374d5f", module.exports)
  }
}
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.table_id && _vm.calculator_type == "mortgage_calculator"
    ? _c("app-mortgage-calc", {
        attrs: {
          ...
          currencyType: _vm.currency_type
        }
      })
